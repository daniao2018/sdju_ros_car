...
const char* fileName="/home/daniao/Music/voice.wav";
const char* playPath="play /home/daniao/Music/voice.wav";
...
{
const char* start = "小刘同学是一款集语音交互，简单视觉导航和蓝牙开箱的智能配送车。由萌萌爱萌新团队制作。";
